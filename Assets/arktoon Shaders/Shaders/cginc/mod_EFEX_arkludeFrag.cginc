float4 frag(VertexOutput i) : COLOR {
    ...
    if(_UseEmissionParallax) {
        ...
        float3 _EmissiveFreak1Tex_var = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak1Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak1Transform, _EmissiveFreak1Tex)).rgb * lerp(_EmissiveFreak1Color2.rgb, _EmissiveFreak1Color.rgb, cos(_Time.y * _EmissiveFreak1ColorChangeSpeed) / 2 + 0.5);
        ...
        float3 _EmissiveFreak2Tex_var = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak2Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak2Transform, _EmissiveFreak2Tex)).rgb * lerp(_EmissiveFreak2Color2.rgb, _EmissiveFreak2Color.rgb, cos(_Time.y * _EmissiveFreak2ColorChangeSpeed) / 2 + 0.5);
        ...
        float3 _EmissiveFreak3Tex_var = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak3Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak3Transform, _EmissiveFreak3Tex)).rgb * lerp(_EmissiveFreak3Color2.rgb, _EmissiveFreak3Color.rgb, cos(_Time.y * _EmissiveFreak3ColorChangeSpeed) / 2 + 0.5);
        ...
        float3 _EmissiveFreak4Tex_var = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak4Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak4Transform, _EmissiveFreak4Tex)).rgb * lerp(_EmissiveFreak4Color2.rgb, _EmissiveFreak4Color.rgb, cos(_Time.y * _EmissiveFreak4ColorChangeSpeed) / 2 + 0.5);
        ...
        float3 _EmissiveFreak5Tex_var = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak5Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak5Transform, _EmissiveFreak5Tex)).rgb * lerp(_EmissiveFreak5Color2.rgb, _EmissiveFreak5Color.rgb, cos(_Time.y * _EmissiveFreak5ColorChangeSpeed) / 2 + 0.5);
