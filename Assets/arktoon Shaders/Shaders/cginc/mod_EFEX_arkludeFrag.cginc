float4 frag(VertexOutput i) : COLOR {
    ...
    if(_UseEmissionParallax) {
        ...
        float _EmissiveFreak1Mask_var =  lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak1Mask2, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak1Mask2)).r, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak1Mask, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak1Mask)).r, cos(_Time.y * _EmissiveFreak1MaskTransitionSpeed) / 2 + 0.5);
        float3 _EmissiveFreak1Tex_var = lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak1Tex2, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak1Transform, _EmissiveFreak1Tex2)).rgb, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak1Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak1Transform, _EmissiveFreak1Tex)).rgb, cos(_Time.y * _EmissiveFreak1TransitionSpeed) / 2 + 0.5) * lerp(_EmissiveFreak1Color2.rgb, _EmissiveFreak1Color.rgb, cos(_Time.y * _EmissiveFreak1ColorChangeSpeed) / 2 + 0.5);
        ...
        float _EmissiveFreak2Mask_var =  lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak2Mask2, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak2Mask2)).r, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak2Mask, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak2Mask)).r, cos(_Time.y * _EmissiveFreak2MaskTransitionSpeed) / 2 + 0.5);
        float3 _EmissiveFreak2Tex_var = lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak2Tex2, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak2Transform, _EmissiveFreak2Tex2)).rgb, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak2Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak2Transform, _EmissiveFreak2Tex)).rgb, cos(_Time.y * _EmissiveFreak2TransitionSpeed) / 2 + 0.5) * lerp(_EmissiveFreak2Color2.rgb, _EmissiveFreak2Color.rgb, cos(_Time.y * _EmissiveFreak2ColorChangeSpeed) / 2 + 0.5);
        ...
        float _EmissiveFreak3Mask_var =  lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak3Mask2, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak3Mask2)).r, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak3Mask, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak3Mask)).r, cos(_Time.y * _EmissiveFreak3MaskTransitionSpeed) / 2 + 0.5);
        float3 _EmissiveFreak3Tex_var = lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak3Tex2, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak3Transform, _EmissiveFreak3Tex2)).rgb, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak3Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak3Transform, _EmissiveFreak3Tex)).rgb, cos(_Time.y * _EmissiveFreak3TransitionSpeed) / 2 + 0.5) * lerp(_EmissiveFreak3Color2.rgb, _EmissiveFreak3Color.rgb, cos(_Time.y * _EmissiveFreak3ColorChangeSpeed) / 2 + 0.5);
        ...
        float _EmissiveFreak4Mask_var =  lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak4Mask2, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak4Mask2)).r, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak4Mask, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak4Mask)).r, cos(_Time.y * _EmissiveFreak4MaskTransitionSpeed) / 2 + 0.5);
        float3 _EmissiveFreak4Tex_var = lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak4Tex2, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak4Transform, _EmissiveFreak4Tex2)).rgb, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak4Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak4Transform, _EmissiveFreak4Tex)).rgb, cos(_Time.y * _EmissiveFreak4TransitionSpeed) / 2 + 0.5) * lerp(_EmissiveFreak4Color2.rgb, _EmissiveFreak4Color.rgb, cos(_Time.y * _EmissiveFreak4ColorChangeSpeed) / 2 + 0.5);
        ...
        float _EmissiveFreak5Mask_var =  lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak5Mask2, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak5Mask2)).r, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak5Mask, REF_MAINTEX, TRANSFORM_TEX(i.uv0, _EmissiveFreak5Mask)).r, cos(_Time.y * _EmissiveFreak5MaskTransitionSpeed) / 2 + 0.5);
        float3 _EmissiveFreak5Tex_var = lerp(UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak5Tex2, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak5Transform, _EmissiveFreak5Tex2)).rgb, UNITY_SAMPLE_TEX2D_SAMPLER(_EmissiveFreak5Tex, REF_MAINTEX, TRANSFORM_TEX(emissiveFreak5Transform, _EmissiveFreak5Tex)).rgb, cos(_Time.y * _EmissiveFreak5TransitionSpeed) / 2 + 0.5) * lerp(_EmissiveFreak5Color2.rgb, _EmissiveFreak5Color.rgb, cos(_Time.y * _EmissiveFreak5ColorChangeSpeed) / 2 + 0.5);
