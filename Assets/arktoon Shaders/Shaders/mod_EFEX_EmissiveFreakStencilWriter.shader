...
Shader "arktoon/_mod_Extra/EmissiveFreakExtend/StencilWriterCutout" {
    Properties {
        // Double Sided
        ...
        _EmissiveFreak1Tex2 ("[EmissiveFreak] Texture2", 2D ) = "white" {}
        _EmissiveFreak1TransitionSpeed ("[EmissiveFreak] Transition Speed", Float ) = 0
        ...
        _EmissiveFreak1Mask2 ("[EmissiveFreak] Mask2", 2D ) = "white" {}
        _EmissiveFreak1MaskTransitionSpeed ("[EmissiveFreak] Mask Transition Speed", Float ) = 0
        _EmissiveFreak1U ("[EmissiveFreak] U Scroll", Float ) = 0
        _EmissiveFreak1V ("[EmissiveFreak] V Scroll", Float ) = 0
        _EmissiveFreak1USinAmp ("[EmissiveFreak] U Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak1USinFreq ("[EmissiveFreak] U Scroll Sin Frequency", Float ) = 0
        _EmissiveFreak1VSinAmp ("[EmissiveFreak] V Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak1VSinFreq ("[EmissiveFreak] V Scroll Sin Frequency", Float ) = 0
        ...
        _EmissiveFreak2Tex ("[EmissiveFreak] Texture", 2D ) = "white" {}
        _EmissiveFreak2Tex2 ("[EmissiveFreak] Texture2", 2D ) = "white" {}
        _EmissiveFreak2TransitionSpeed ("[EmissiveFreak] Transition Speed", Float ) = 0
        [HDR]_EmissiveFreak2Color ("[EmissiveFreak] Color", Color ) = (0,0,0,1)
        ...
        _EmissiveFreak2Mask ("[EmissiveFreak] Mask", 2D ) = "white" {}
        _EmissiveFreak2Mask2 ("[EmissiveFreak] Mask2", 2D ) = "white" {}
        _EmissiveFreak2MaskTransitionSpeed ("[EmissiveFreak] Mask Transition Speed", Float ) = 0
        _EmissiveFreak2U ("[EmissiveFreak2] U Scroll", Float ) = 0
        _EmissiveFreak2V ("[EmissiveFreak2] V Scroll", Float ) = 0
        _EmissiveFreak2USinAmp ("[EmissiveFreak] U Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak2USinFreq ("[EmissiveFreak] U Scroll Sin Frequency", Float ) = 0
        _EmissiveFreak2VSinAmp ("[EmissiveFreak] V Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak2VSinFreq ("[EmissiveFreak] V Scroll Sin Frequency", Float ) = 0
        ...
        _EmissiveFreak3Tex ("[EmissiveFreak] Texture", 2D ) = "white" {}
        _EmissiveFreak3Tex2 ("[EmissiveFreak] Texture2", 2D ) = "white" {}
        _EmissiveFreak3TransitionSpeed ("[EmissiveFreak] Transition Speed", Float ) = 0
        [HDR]_EmissiveFreak3Color ("[EmissiveFreak] Color", Color ) = (0,0,0,1)
        ...
        _EmissiveFreak3Mask ("[EmissiveFreak] Mask", 2D ) = "white" {}
        _EmissiveFreak3Mask2 ("[EmissiveFreak] Mask2", 2D ) = "white" {}
        _EmissiveFreak3MaskTransitionSpeed ("[EmissiveFreak] Mask Transition Speed", Float ) = 0
        _EmissiveFreak3U ("[EmissiveFreak3] U Scroll", Float ) = 0
        _EmissiveFreak3V ("[EmissiveFreak3] V Scroll", Float ) = 0
        _EmissiveFreak3USinAmp ("[EmissiveFreak] U Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak3USinFreq ("[EmissiveFreak] U Scroll Sin Frequency", Float ) = 0
        _EmissiveFreak3VSinAmp ("[EmissiveFreak] V Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak3VSinFreq ("[EmissiveFreak] V Scroll Sin Frequency", Float ) = 0
        ...
        _EmissiveFreak4Tex ("[EmissiveFreak] Texture", 2D ) = "white" {}
        _EmissiveFreak4Tex2 ("[EmissiveFreak] Texture2", 2D ) = "white" {}
        _EmissiveFreak4TransitionSpeed ("[EmissiveFreak] Transition Speed", Float ) = 0
        [HDR]_EmissiveFreak4Color ("[EmissiveFreak] Color", Color ) = (0,0,0,1)
        ...
        _EmissiveFreak4Mask ("[EmissiveFreak] Mask", 2D ) = "white" {}
        _EmissiveFreak4Mask2 ("[EmissiveFreak] Mask2", 2D ) = "white" {}
        _EmissiveFreak4MaskTransitionSpeed ("[EmissiveFreak] Mask Transition Speed", Float ) = 0
        _EmissiveFreak4U ("[EmissiveFreak4] U Scroll", Float ) = 0
        _EmissiveFreak4V ("[EmissiveFreak4] V Scroll", Float ) = 0
        _EmissiveFreak4USinAmp ("[EmissiveFreak] U Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak4USinFreq ("[EmissiveFreak] U Scroll Sin Frequency", Float ) = 0
        _EmissiveFreak4VSinAmp ("[EmissiveFreak] V Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak4VSinFreq ("[EmissiveFreak] V Scroll Sin Frequency", Float ) = 0
        ...
        _EmissiveFreak5Tex ("[EmissiveFreak] Texture", 2D ) = "white" {}
        _EmissiveFreak5Tex2 ("[EmissiveFreak] Texture2", 2D ) = "white" {}
        _EmissiveFreak5TransitionSpeed ("[EmissiveFreak] Transition Speed", Float ) = 0
        [HDR]_EmissiveFreak5Color ("[EmissiveFreak] Color", Color ) = (0,0,0,1)
        ...
        _EmissiveFreak5Mask ("[EmissiveFreak] Mask", 2D ) = "white" {}
        _EmissiveFreak5Mask2 ("[EmissiveFreak] Mask2", 2D ) = "white" {}
        _EmissiveFreak5MaskTransitionSpeed ("[EmissiveFreak] Mask Transition Speed", Float ) = 0
        _EmissiveFreak5U ("[EmissiveFreak5] U Scroll", Float ) = 0
        _EmissiveFreak5V ("[EmissiveFreak5] V Scroll", Float ) = 0
        _EmissiveFreak5USinAmp ("[EmissiveFreak] U Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak5USinFreq ("[EmissiveFreak] U Scroll Sin Frequency", Float ) = 0
        _EmissiveFreak5VSinAmp ("[EmissiveFreak] V Scroll Sin Amplitude", Float ) = 0
        _EmissiveFreak5VSinFreq ("[EmissiveFreak] V Scroll Sin Frequency", Float ) = 0
